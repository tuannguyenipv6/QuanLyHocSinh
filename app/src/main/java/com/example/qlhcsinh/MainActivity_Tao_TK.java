...
public class MainActivity_Tao_TK extends AppCompatActivity {
    ...
    String urlAddData = "http://192.168.0.126:8080/QLHS/TaoTaiKhoan.php";
    @Override
    ...
    public void onClickTTK(View view){
        switch (view.getId()){
            ...
            case R.id.hotrMTK:
                ...
                //hổ trợ về mã lớp
            case R.id.hotrML:
                String gv = "Mã lớp này là 1 mã được đặt riêng cho 1 lớp do 1 giáo viên quản lý, mã lớp được dùng để truy vấn thông tin của lớp đó";
                HoTro("Mã lớp", gv);
                break;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("Thành Công")){
                            ...
                            Toast.makeText(MainActivity_Tao_TK.this, "Tài khoản hoặc mã tài khoản đã tồn tại!", Toast.LENGTH_SHORT).show();
